...
export class PlayerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.playerService
      ...
      .subscribe(
        (res: HttpResponse<IPlayer[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPlayers(): void {
    this.eventSubscriber = this.eventManager.subscribe('playerListModification', () => this.loadPage());
  }
