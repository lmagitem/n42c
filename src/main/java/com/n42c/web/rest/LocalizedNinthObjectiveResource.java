...
public class LocalizedNinthObjectiveResource {
    ...
    public ResponseEntity<LocalizedNinthObjective> createLocalizedNinthObjective(@Valid @RequestBody LocalizedNinthObjective localizedNinthObjective) throws URISyntaxException {
    ...
    public ResponseEntity<LocalizedNinthObjective> updateLocalizedNinthObjective(@Valid @RequestBody LocalizedNinthObjective localizedNinthObjective) throws URISyntaxException {
