...
public class LocalizedPostContentResource {
  ...
  public ResponseEntity<LocalizedPostContent> createLocalizedPostContent(@Valid @RequestBody LocalizedPostContent localizedPostContent)
    ...
    return ResponseEntity
      .created(new URI("/api/localized-post-contents/" + result.getId()))
  ...
  public ResponseEntity<LocalizedPostContent> updateLocalizedPostContent(@Valid @RequestBody LocalizedPostContent localizedPostContent)
    throws URISyntaxException {
