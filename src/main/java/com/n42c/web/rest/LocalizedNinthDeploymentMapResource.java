...
public class LocalizedNinthDeploymentMapResource {
    ...
    public ResponseEntity<LocalizedNinthDeploymentMap> createLocalizedNinthDeploymentMap(@RequestBody LocalizedNinthDeploymentMap localizedNinthDeploymentMap) throws URISyntaxException {
    ...
    public ResponseEntity<LocalizedNinthDeploymentMap> updateLocalizedNinthDeploymentMap(@RequestBody LocalizedNinthDeploymentMap localizedNinthDeploymentMap) throws URISyntaxException {
