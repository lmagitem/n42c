...
describe('Service Tests', () => {
  describe('LocalizedNinthObjective Service', () => {
    ...
    let elemDefault: ILocalizedNinthObjective;
    let expectedResult: ILocalizedNinthObjective | ILocalizedNinthObjective[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a LocalizedNinthObjective', () => {
        ...
        service.create(new LocalizedNinthObjective()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a LocalizedNinthObjective', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should return a list of LocalizedNinthObjective', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should delete a LocalizedNinthObjective', () => {
