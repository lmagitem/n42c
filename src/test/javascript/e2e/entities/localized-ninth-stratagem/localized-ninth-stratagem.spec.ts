...
describe('LocalizedNinthStratagem e2e test', () => {
  ...
  /* it('should create and save LocalizedNinthStratagems', async () => {
        ...
        expect(await localizedNinthStratagemUpdatePage.getDescriptionInput()).to.eq('description', 'Expected Description value to be equals to description');
        expect(await localizedNinthStratagemUpdatePage.getKeywordsInput()).to.eq('keywords', 'Expected Keywords value to be equals to keywords');
        ...
        expect(await localizedNinthStratagemComponentsPage.countDeleteButtons()).to.eq(nbButtonsBeforeCreate + 1, 'Expected one more entry in the table');
    }); */
  ...
  /* it('should delete last LocalizedNinthStratagem', async () => {
        ...
        expect(await localizedNinthStratagemDeleteDialog.getDialogTitle())
            .to.eq('n42cApp.localizedNinthStratagem.delete.question');
