...
import {
  PlayerComponentsPage,
  /* PlayerDeleteDialog, */
  PlayerUpdatePage,
} from './player.page-object';
...
describe('Player e2e test', () => {
  ...
  /* it('should create and save Players', async () => {
        ...
        await promise.all([
            ...
            playerUpdatePage.appUserSelectLastOption(),
        ]);
  ...
  /* it('should delete last Player', async () => {
        ...
        expect(await playerDeleteDialog.getDialogTitle())
            .to.eq('n42cApp.player.delete.question');
