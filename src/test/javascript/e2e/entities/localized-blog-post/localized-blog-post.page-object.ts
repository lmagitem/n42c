...
export class LocalizedBlogPostComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-localized-blog-post div table .btn-danger'));
  title = element.all(by.css('jhi-localized-blog-post div h2#page-heading span')).first();
...
export class LocalizedBlogPostUpdatePage {
  pageTitle = element(by.id('jhi-localized-blog-post-heading'));
...
export class LocalizedBlogPostDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-localizedBlogPost-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-localizedBlogPost'));
