...
/**
 * Performance test for the ProfilePartPreciseItem entity.
 */
class ProfilePartPreciseItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProfilePartPreciseItem entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all profilePartPreciseItems")
            .get("/api/profile-part-precise-items")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new profilePartPreciseItem")
            .post("/api/profile-part-precise-items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "title":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created profilePartPreciseItem")
                .get("${new_profilePartPreciseItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created profilePartPreciseItem")
            .delete("${new_profilePartPreciseItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
