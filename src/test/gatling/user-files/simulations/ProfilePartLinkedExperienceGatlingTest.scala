...
/**
 * Performance test for the ProfilePartLinkedExperience entity.
 */
class ProfilePartLinkedExperienceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProfilePartLinkedExperience entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all profilePartLinkedExperiences")
            .get("/api/profile-part-linked-experiences")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new profilePartLinkedExperience")
            .post("/api/profile-part-linked-experiences")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "title":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created profilePartLinkedExperience")
                .get("${new_profilePartLinkedExperience_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created profilePartLinkedExperience")
            .delete("${new_profilePartLinkedExperience_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
